...
\subsection{How are computing fields can affect Climate Change}
    ...
    \begin{quoting}
        \textit{
        ``As we know, the effects of climate change can be recorded in databases. If we want to get more useful information, we cannot ignore the powerful tools of the AI.''       }(\pr{5})
    \end{quoting}
